...
The code overall looked well formatted and outlined. Comments were added to each function to give a brief explanation of its purpose and desired outcome. 😎

We have noticed the lack of a catch Exception for the first function retireveconcertSummaries() and added a catch that returned a 404 response. 🎣
